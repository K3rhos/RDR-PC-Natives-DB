...
namespace Rage
{
	...
	static void WAIT(int ms) { Invoke<0x7715C03B, void>(ms); }
	...
	static void UI_SET_STRING(char* entry, char* string) { Invoke<0xE457546C, void>(entry, string); }
	...
	static Actor GET_PLAYER_ACTOR(int PlayerId) { return Invoke<0xE8CFDD53, Actor>(PlayerId); }
	...
	static int DECOR_REMOVE(int pram0, int pram1) { return Invoke<0xE0E2640B, int>(pram0, pram1); }
	...
	static int GET_VEHICLE(int pram0) { return Invoke<0xA0936EB6, int>(pram0); }
	...
	static int IS_ACTOR_DRIVING_VEHICLE(int pram0) { return Invoke<0xDC99C124, int>(pram0); }
	...
	static int UI_ISFOCUSED(const char* UiLayer) { return Invoke<0x6F2509E8, int>(UiLayer); }
	...
	static int GET_MOUNT(int pram0) { return Invoke<0xDD31EC4E, int>(pram0); }
	...
	static int IS_ACTOR_RAGDOLL(int pram0) { return Invoke<0x3918D335, int>(pram0); }
	...
	static bool _IS_KEY_DOWN(int keyCode) { return Invoke<0x358F874F, bool>(keyCode); }
	...
	static void UI_REFRESH(const char* pram0) { Invoke<0xFAC3DF71, void>(pram0); }
	...
	static void UI_FOCUS(const char* uiLayer) { Invoke<0x699CC85E, void>(uiLayer); }
	...
	static void UI_SET_STRING_FORMAT(const char* GXTName, const char* FormatString, const char* String1, const char* String2, const char* String3) { Invoke<0xEDA84121, void>(GXTName, FormatString, String1, String2, String3); }
	...
	static void UNK_0xCF065186(int pram0) { Invoke<0xCF065186, void>(pram0); }
