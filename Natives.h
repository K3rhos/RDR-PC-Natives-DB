...
#include "NativesInvoker/NativesInvoker.h"
#include "Enums.h"
...
namespace CORE
{
	...
	static int LOAD_SOFT_SAVE(int _Unk0) { return Invoke<0x0234F932, int>(_Unk0); }
	static int SAVE_GAME(int _Unk0) { return Invoke<0x09C5D8D5, int>(_Unk0); }
	static void SAVE_SOFT_SAVE(int _Unk0) { Invoke<0x1A3BAC68, void>(_Unk0); }
	static void SAVE_MANAGER_HARD_SAVE(int _Unk0) { Invoke<0xED40F27D, void>(_Unk0); }
	static int SAVE_MANAGER_HARD_LOAD(int _Unk0) { return Invoke<0x8C710D3E, int>(_Unk0); }
	static void SAVE_MANAGER_CREATE_SAVE_DISPLAY_NAME(int _Unk0) { Invoke<0x17F34613, void>(_Unk0); }
...
namespace UNSORTED
{
	...
	static int ADD_BLIP_FOR_COORD(int _Unk0, int _Unk1, int _Unk2, int _Unk3, int _Unk4) { return Invoke<0xC6F43D0E, int>(_Unk0, _Unk1, _Unk2, _Unk3, _Unk4); }
	...
	static int ADD_BLIP_FOR_OBJECT(int _Unk0, int _Unk1, int _Unk2, int _Unk3, int _Unk4) { return Invoke<0x0E5372EC, int>(_Unk0, _Unk1, _Unk2, _Unk3, _Unk4); }
	...
	static void SET_WIND(int _Unk0, int _Unk1, int _Unk2) { Invoke<0xC6294698, void>(_Unk0, _Unk1, _Unk2); }
	...
	static int CLEAR_AREA_OF_TREE_TYPE(int _Unk0, int _Unk1, int _Unk2, int _Unk3, int _Unk4) { return Invoke<0x9A93E7CA, int>(_Unk0, _Unk1, _Unk2, _Unk3, _Unk4); }
	static int CLEAR_AREA_OF_BREAKABLE_TREES(int _Unk0, int _Unk1, int _Unk2, int _Unk3) { return Invoke<0x002B0698, int>(_Unk0, _Unk1, _Unk2, _Unk3); }
	static int CLEAR_AREA_OF_GRASS(int _Unk0, int _Unk1, int _Unk2, int _Unk3) { return Invoke<0x9AA8A1B1, int>(_Unk0, _Unk1, _Unk2, _Unk3); }
	...
	static int ADD_BLIP_FOR_ACTOR(int _Unk0, int _Unk1, int _Unk2, int _Unk3, int _Unk4) { return Invoke<0xEFB9362F, int>(_Unk0, _Unk1, _Unk2, _Unk3, _Unk4); }
	...
	static void DEREFERENCE_ACTOR(int _Unk0) { Invoke<0x92339B5E, void>(_Unk0); }
	...
	static int IS_ACTOR_PLAYER(int _Unk0) { return Invoke<0xB27E91E7, int>(_Unk0); }
